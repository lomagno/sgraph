...
export class OptionsComponent implements AfterViewInit {
  ...
  get showAxisPointFC() { return this.form.get('showAxisPoint'); } 
  ...
  constructor(
    private formBuilder: FormBuilder) {
      this.form = this.formBuilder.group({
        ...
        showAxisPoint: [null, [Validators.required]]
      });      
      this.form.valueChanges.subscribe(() => {
        this.onChangedEventEmitter.emit({
          ...
          showAxisPointer: this.showAxisPointFC?.value
        });
      });
  }
  ...
  ngAfterViewInit(): void {
    ...
    this.showAxisPointFC?.setValue(this.model.showAxisPointer);
  }
}
